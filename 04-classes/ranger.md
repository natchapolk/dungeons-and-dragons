...
- **เกราะหนังหมุด (Studded Leather Armor)** ให้ AC 12 บวก DEX เต็มจำนวน และไม่กระทบการทอย Stealth
- **ดาบโค้ง (Scimitar)** ดาเมจ 1d6 Slashing ความชำนาญ Nick ทำให้โจมตีมือสองโดยไม่เสีย Bonus Action
- **ดาบสั้น (Shortsword)** ดาเมจ 1d6 Piercing ความชำนาญ Vex ใช้คู่กับดาบโค้งเป็นสายสองอาวุธ
- **ธนูยาว (Longbow)** ดาเมจ 1d8 Piercing ความชำนาญ Slow ยิงได้ไกล 150 ฟุต พร้อม **ลูกธนู (Arrows)** 20 ดอก
- **กระบอกใส่ลูกธนู (Quiver)** ใส่ลูกธนูได้ 20 ดอก สายธนูต้องมีอันนี้
- **สื่อเวทดรูอิด (Druidic Focus)** แบบไม้เท้าไม้ เป็น Spellcasting Focus ของ Ranger
- **ชุดนักสำรวจ (Explorer's Pack)** มีที่นอน เสบียง เชือก และคบไฟครบ
- เงินติดตัว 7 GP

**เลือก B** รับเงิน 150 GP ไปซื้อของเอง

แนะนำอย่างยิ่งสำหรับมือใหม่ ให้เลือก A เพราะชุดนี้ให้ทั้งชุดระยะไกลและชุดสองอาวุธมาพร้อมกัน
คุณจึงลองเล่นทั้งสองแนวได้โดยไม่ต้องซื้อของเพิ่ม แล้วค่อยตัดสินใจตอนเลเวล 2 ว่าจะไปทางไหน

ข้อควรระวัง Ranger ได้ **ความชำนาญอาวุธ (Weapon Mastery)** 2 ชนิดตั้งแต่เลเวล 1
ถ้าเล่นสายธนูให้เลือก Slow ของธนูยาว ถ้าเล่นสองอาวุธให้เลือก Nick ของดาบโค้งคู่กับ Vex ของดาบสั้น
...
- **เลเวล 3** Proficiency Bonus +2, ได้ความสามารถ Ranger Subclass [แนะนำ], Favored Enemy 2, เตรียมสเปลได้ 4, Slot 1 3
- **เลเวล 4** Proficiency Bonus +2, ได้ความสามารถ ASI, Favored Enemy 2, เตรียมสเปลได้ 5, Slot 1 3
- **เลเวล 5** Proficiency Bonus +3, ได้ความสามารถ Extra Attack [แนะนำ], Favored Enemy 3, เตรียมสเปลได้ 6, Slot 1 4, Slot 2 2
- **เลเวล 6** Proficiency Bonus +3, ได้ความสามารถ Roving, Favored Enemy 3, เตรียมสเปลได้ 6, Slot 1 4, Slot 2 2
- **เลเวล 7** Proficiency Bonus +3, ได้ความสามารถ Subclass Feature, Favored Enemy 3, เตรียมสเปลได้ 7, Slot 1 4, Slot 2 3
- **เลเวล 8** Proficiency Bonus +3, ได้ความสามารถ ASI, Favored Enemy 3, เตรียมสเปลได้ 7, Slot 1 4, Slot 2 3
- **เลเวล 9** Proficiency Bonus +4, ได้ความสามารถ Expertise [แนะนำ], Favored Enemy 4, เตรียมสเปลได้ 9, Slot 1 4, Slot 2 3, Slot 3 2
- **เลเวล 10** Proficiency Bonus +4, ได้ความสามารถ Tireless, Favored Enemy 4, เตรียมสเปลได้ 9, Slot 1 4, Slot 2 3, Slot 3 2
- **เลเวล 11** Proficiency Bonus +4, ได้ความสามารถ Subclass Feature, Favored Enemy 4, เตรียมสเปลได้ 10, Slot 1 4, Slot 2 3, Slot 3 3
- **เลเวล 12** Proficiency Bonus +4, ได้ความสามารถ ASI, Favored Enemy 4, เตรียมสเปลได้ 10, Slot 1 4, Slot 2 3, Slot 3 3
- **เลเวล 13** Proficiency Bonus +5, ได้ความสามารถ Relentless Hunter [แนะนำ], Favored Enemy 5, เตรียมสเปลได้ 11, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 1
- **เลเวล 14** Proficiency Bonus +5, ได้ความสามารถ Nature's Veil, Favored Enemy 5, เตรียมสเปลได้ 11, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 1
- **เลเวล 15** Proficiency Bonus +5, ได้ความสามารถ Subclass Feature, Favored Enemy 5, เตรียมสเปลได้ 12, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 2
- **เลเวล 16** Proficiency Bonus +5, ได้ความสามารถ ASI, Favored Enemy 5, เตรียมสเปลได้ 12, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 2
- **เลเวล 17** Proficiency Bonus +6, ได้ความสามารถ Precise Hunter [แนะนำ], Favored Enemy 6, เตรียมสเปลได้ 14, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 3, Slot 5 1
- **เลเวล 18** Proficiency Bonus +6, ได้ความสามารถ Feral Senses, Favored Enemy 6, เตรียมสเปลได้ 14, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 3, Slot 5 1
- **เลเวล 19** Proficiency Bonus +6, ได้ความสามารถ Epic Boon Feat, Favored Enemy 6, เตรียมสเปลได้ 15, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 3, Slot 5 2
- **เลเวล 20** Proficiency Bonus +6, ได้ความสามารถ Foe Slayer, Favored Enemy 6, เตรียมสเปลได้ 15, Slot 1 4, Slot 2 3, Slot 3 3, Slot 4 3, Slot 5 2
...
[แนะนำมาก] เรียกสัตว์วิญญาณคู่ใจด้วย **ใช้เวลา 1 ชั่วโมง (Magic action)** เลือก 1 แบบ:
...
Ranger ใช้ค่า WIS ในการร่ายเวท
...
รายการเวททั้งหมดของคลาสนี้ พร้อมรายละเอียดว่าร่ายด้วยอะไร ระยะเท่าไหร่ และให้ผลยังไง ย้ายไปอยู่ที่ [เวทของพรานป่า (Ranger)](../10-spells/class-lists/ranger.md) แล้ว
