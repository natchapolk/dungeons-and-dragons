...
- **หอก (Spear)** ดาเมจ 1d6 Piercing คุณสมบัติ Versatile ถือสองมือได้ 1d8 และเข้าเงื่อนไข Monk Weapon จึงใช้กับ Martial Arts ได้
- **ลูกดอก (Dart)** 5 อัน ดาเมจ 1d4 Piercing คุณสมบัติ Finesse และขว้างได้ไกล 20 ฟุต ใช้ตอนศัตรูอยู่ไกล
- **เครื่องมือช่าง (Artisan's Tools)** หรือ **เครื่องดนตรี (Musical Instrument)** เลือกได้อย่างใดอย่างหนึ่ง
- **ชุดนักสำรวจ (Explorer's Pack)** มีที่นอน เสบียง เชือก และคบไฟครบ
- เงินติดตัว 11 GP

**เลือก B** รับเงิน 50 GP ไปซื้อของเอง

แนะนำสำหรับมือใหม่ ให้เลือก A เพราะ Monk ไม่ใส่เกราะและไม่ถือโล่อยู่แล้ว
เงิน 50 GP จึงไม่มีอะไรให้ซื้อที่คุ้มกว่าของในชุดนี้

ข้อควรระวัง Monk ไม่ได้ระบบ **ความชำนาญอาวุธ (Weapon Mastery)** ในกฎ 2024
มีแค่ 5 คลาสที่ได้ คือ Barbarian, Fighter, Paladin, Ranger และ Rogue
Monk ใช้ **ศิลปะการต่อสู้ (Martial Arts)** ซึ่งเป็นคนละระบบกัน อย่าจดความชำนาญอาวุธลงใบตัวละคร
