...
- **ขวานใหญ่ (Greataxe)** ดาเมจ 1d12 Slashing ความชำนาญ Cleave ใช้ตีศัตรูสองตัวที่ยืนติดกันได้
- **ขวานมือ (Handaxe)** 4 อัน ดาเมจ 1d6 Slashing ความชำนาญ Vex ขว้างได้ไกล 20 ฟุต ใช้ตอนศัตรูอยู่ไกลเกินเอื้อม
- **ชุดนักสำรวจ (Explorer's Pack)** มีที่นอน เสบียง เชือก และคบไฟครบ
- เงินติดตัว 15 GP

**เลือก B** รับเงิน 75 GP ไปซื้อของเอง

แนะนำสำหรับมือใหม่ ให้เลือก A เพราะ Barbarian ไม่ใส่เกราะอยู่แล้ว
จึงไม่ต้องเก็บเงินไว้ซื้อเกราะ และขวานมือ 4 อันแก้ปัญหาศัตรูบินได้ที่ Barbarian ตีไม่ถึง
ส่วนเลือก B เหมาะกับคนที่อยากเปลี่ยนไปใช้ **ค้อนสงคราม (Maul)** ที่ให้ความชำนาญ Topple แทน
...
**ระยะเวลา:** คงอยู่ จนจบเทิร์นหน้าของคุณ เท่านั้น แล้วต้องต่ออายุทีละรอบ ยืดได้สูงสุด 10 นาที (กฎ 2014 เพดานอยู่ที่ 1 นาที)
...
เมื่อคุณใช้ Bonus Action เข้า Rage คุณสามารถเคลื่อนที่ได้ทันทีเป็นระยะครึ่งหนึ่งของ Speed
...
**เมื่อคุณใช้ Reckless Attack** คุณสามารถสละ Advantage ของการโจมตี 1 ครั้ง เพื่อ:
...
- **Sundering Blow** การโจมตีครั้งถัดไปของเพื่อนร่วมทีมต่อเป้าหมายนั้น +5 ในการทอยโจมตี
...
Brutal Strike เพิ่มดาเมจเป็น 3d10 และใช้ผลพิเศษได้ 2 อย่างพร้อมกัน (ต้องสละ Advantage 2 ครั้ง)
...
ระหว่าง Rage: HP ที่เหลือ 0 ไม่ทำให้คุณหมดสติ คุณยังทอย Death Save แต่ยังสู้ต่อได้ตามปกติ จนกว่า Rage จะจบ (ถ้าล้มเหลว 3 ครั้ง = ตายเมื่อ Rage จบ)
...
- คิดว่ากด Rage แล้วติดยาว 10 นาที ไม่ใช่ Rage อยู่แค่ถึงจบเทิร์นหน้า ต้องโจมตีศัตรู / บังคับให้ศัตรูทอย Save / ใช้ Bonus Action ต่ออายุ ในทุกเทิร์น 10 นาทีคือเพดานสูงสุด
