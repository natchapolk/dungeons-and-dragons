...
**เลือก A** สำหรับสาย STR

- **เกราะโซ่ (Chain Mail)** ให้ AC 16 คงที่ ไม่บวก DEX ต้องมี STR อย่างน้อย 13 ไม่งั้น Speed ลด 10 ฟุต และทำให้ทอย Stealth เสียเปรียบ
- **ดาบใหญ่ (Greatsword)** ดาเมจ 2d6 Slashing ความชำนาญ Graze ทำให้ตีพลาดก็ยังได้ดาเมจเท่า STR modifier
- **ขวานมือ (Handaxe)** 2 อัน ดาเมจ 1d6 Slashing ความชำนาญ Vex ขว้างได้ไกล 20 ฟุต
- **ชุดนักลุยดันเจี้ยน (Dungeoneer's Pack)** มีชะแลง เทียนไข เสบียง และเชือก
- เงินติดตัว 4 GP

**เลือก B** สำหรับสาย DEX
...
**เลือก C** รับเงิน 155 GP ไปซื้อของเอง

แนะนำสำหรับมือใหม่ ให้เลือก A เพราะ AC 16 ตั้งแต่เลเวล 1 สูงกว่าที่สาย DEX ทำได้ในตอนต้นเกม
และดาบใหญ่ทำดาเมจสม่ำเสมอกว่าเพราะความชำนาญ Graze ทำให้แทบไม่มีเทิร์นไหนเสียเปล่า
เลือก C ให้เงินมากที่สุดในบรรดาทุกคลาส แต่ต้องรู้จักของในเกมพอสมควรถึงจะซื้อได้คุ้ม
...
**Nick มีค่ามาก** ทำให้โจมตีมือสองได้โดยไม่ต้องใช้ Bonus Action = เอา Bonus Action ไปทำอย่างอื่นได้
...
เมื่อคุณทอย Ability Check ล้มเหลว คุณสามารถใช้ Second Wind 1 ครั้ง เพื่อ:
...
**เมื่อคุณใช้ Second Wind** คุณสามารถเคลื่อนที่ได้ครึ่งหนึ่งของ Speed โดยไม่โดน Opportunity Attack

---

### เลเวล 9 ไม่ยอมแพ้ (Indomitable)

เมื่อคุณทอย Saving Throw ล้มเหลว คุณสามารถทอยใหม่ได้ พร้อมบวก +เลเวล Fighter เข้าไปในผลใหม่ (ต้องใช้ผลใหม่)
...
คุณสามารถเปลี่ยน Mastery ของการโจมตีครั้งนั้นเป็น Push, Sap, หรือ Slow แทนได้
...
**Bonus Action:** ศึกษาศัตรูที่มองเห็นในระยะ 30 ฟุต รู้ว่ามันมีค่า Ability สูงกว่าหรือต่ำกว่าคุณ และรู้ **AC, Immunity, Resistance, Vulnerability** ของมัน ใช้ได้ Prof Bonus ครั้ง/Long Rest
...
เมื่อใช้ **Attack action** คุณสามารถแทนการโจมตี 1 ครั้ง ด้วยการร่าย Cantrip
...
เมื่อใช้ Attack action คุณสามารถแทนการโจมตี 1 ครั้ง ด้วยการร่ายสเปลระดับ 1 หรือ 2
...
**Resistance ต่อ Psychic damage** และ เมื่อเริ่มเทิร์นโดยมีสภาวะ Charmed หรือ Frightened ใช้ 1 เต๋าเพื่อลบสภาวะนั้นทันที
