...
- **ไม่ใช่ทุกคนที่ใช้ได้** เฉพาะคลาสสายรบ 5 คลาสเท่านั้น ได้แก่ Barbarian, Fighter, Paladin, Ranger และ Rogue ส่วน Bard, Cleric, Druid, Monk, Sorcerer, Warlock และ Wizard ไม่ได้ระบบนี้เลย
...
- **นักพรตหมัด (Monk)** ไม่ได้ระบบนี้เลย Monk ใช้ **ศิลปะการต่อสู้ (Martial Arts)** ซึ่งเป็นคนละระบบกัน
...
- **คิดว่าคลาสอื่นก็ใช้ได้** Wizard, Cleric, Druid, Sorcerer, Warlock, Bard และ Monk ไม่ได้ระบบนี้เลย แม้จะถืออาวุธชนิดนั้นอยู่ คนที่พลาดบ่อยที่สุดคือ Monk เพราะเป็นคลาสสายรบเหมือนกัน แต่ Monk ใช้ **ศิลปะการต่อสู้ (Martial Arts)** แทน
...
## ของใช้ผจญภัยและของอื่นที่ไม่ใช่อาวุธและเกราะ

ของใช้ผจญภัยประมาณ 100 ชิ้น, ชุดอุปกรณ์สำเร็จทั้ง 7 ชุดพร้อมของข้างใน,
Spellcasting Focus และองค์ประกอบเวท, เครื่องมือทุกชนิด, ยา และน้ำหนักที่แบกได้
ย้ายไปอยู่ในไฟล์แยกแล้ว เพื่อให้ไฟล์นี้เหลือเฉพาะของที่ใช้ตอนสู้

อ่านรายละเอียดเต็มได้ที่ [ของใช้ผจญภัยและไอเทม](12-gear-and-items.md)

---

## สรุปอุปกรณ์ในหนึ่งบรรทัด

เลือกอาวุธจาก Mastery ที่อยากได้ก่อนแล้วค่อยดูดาเมจ และเลือกเกราะให้ตรงกับ Proficiency ที่คลาสให้

---

## อ่านต่อ

- [ของใช้ผจญภัยและไอเทม](12-gear-and-items.md)
