...
**เลือก A:** Greataxe, ×4 Handaxe, Explorer's Pack, **15 GP**
...
| เลเวล | Prof<br>Bonus | Features (ความสามารถ) | Rages<br>(ครั้ง/วัน) | Rage<br>Damage | Weapon<br>Mastery |
|---|---|---|---|---|---|
| **1** | +2 | **Rage**, **Unarmored Defense**, **Weapon Mastery** | **2** | **+2** | 2 |
| **2** | +2 | **Danger Sense**, **Reckless Attack** | 2 | +2 | 2 |
| **3** | +2 | **Primal Path (Subclass)** [แนะนำ], **Primal Knowledge** | **3** | +2 | 2 |
| **4** | +2 | **Ability Score Improvement (ASI)** | 3 | +2 | **3** |
| **5** | **+3** | **Extra Attack** [แนะนำ], **Fast Movement** | 3 | +2 | 3 |
| **6** | +3 | **Subclass Feature** | **4** | +2 | 3 |
| **7** | +3 | **Feral Instinct**, **Instinctive Pounce** | 4 | +2 | 3 |
| **8** | +3 | **ASI** | 4 | +2 | 3 |
| **9** | **+4** | **Brutal Strike** | 4 | **+3** | 3 |
| **10** | +4 | **Subclass Feature** | 4 | +3 | **4** |
| **11** | +4 | **Relentless Rage** [แนะนำ] | 4 | +3 | 4 |
| **12** | +4 | **ASI** | **5** | +3 | 4 |
...
| **19** | +6 | **Epic Boon Feat** | 6 | +4 | 4 |
| **20** | +6 | **Primal Champion** | **ไม่จำกัด** | +4 | 4 |
...
**เปลี่ยนจากกฎ 2014:** กฎเดิม HP กลับมาแค่ **1** เท่านั้น กฎ 2024 ให้ **2 × เลเวล** — เลเวล 11 คือกลับมา **22 HP**, เลเวล 20 คือ **40 HP**
...
|---|---|---|
| **3** | **Frenzy** | ระหว่าง Rage เมื่อโจมตีแบบ Reckless Attack ให้เพิ่มดาเมจ **1d6** (เพิ่มเป็น 2d6 ที่เลเวล 9, 3d6 ที่ 13, 4d6 ที่ 17) — **1 ครั้ง/เทิร์น** |
| **6** | **Mindless Rage** | ระหว่าง Rage คุณ **ภูมิคุ้มกันสภาวะ Charmed และ Frightened** |
| **10** | **Retaliation** | **Reaction:** เมื่อรับดาเมจจากศัตรูในระยะ 5 ฟุต โจมตีกลับ 1 ครั้ง |
| **14** | **Intimidating Presence** | **Bonus Action:** สิ่งมีชีวิตที่เลือกในระยะ 30 ฟุต ทอย **WIS Save (DC = 8+STR+Prof)** — ล้มเหลว = **Frightened 1 นาที** — ใช้ได้ Prof Bonus ครั้ง/Long Rest |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Animal Speaker** | ร่าย `Beast Sense` และ `Speak with Animals` ได้แบบ **Ritual** โดยไม่ใช้ Spell Slot |
| **3** | **Rage of the Wilds** | เมื่อเข้า Rage เลือกวิญญาณ 1 ตัว:<br> **Bear** — Resistance ต่อทุกดาเมจ ยกเว้น Force, Necrotic, Psychic, Radiant<br> **Eagle** — ได้ **Disengage + Dash เป็น Bonus Action ฟรี**<br> **Wolf** — เพื่อนได้ **Advantage** เมื่อตีศัตรูในระยะ 5 ฟุตจากคุณ |
| **6** | **Aspect of the Wilds** | เลือกพร 1 อย่าง (เปลี่ยนได้ตอน Long Rest):<br> **Owl** — Darkvision 60 ft (หรือ +60 ถ้ามีอยู่แล้ว)<br> **Panther** — **Climb Speed = Speed**<br> **Salmon** — **Swim Speed = Speed** |
| **10** | **Nature Speaker** | ร่าย `Commune with Nature` ได้แบบ Ritual |
| **14** | **Power of the Wilds** | เมื่อ Rage เลือกเพิ่ม 1 อย่าง:<br> **Falcon** — **Fly Speed = Speed** (ถ้าไม่ใส่ Medium/Heavy Armor)<br> **Lion** — ศัตรูในระยะ 5 ฟุตที่ตีคนอื่นที่ไม่ใช่คุณ **เสียเปรียบ**<br> **Ram** — เมื่อตีโดน ทำให้เป้าหมาย **Prone** ได้ |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Vitality of the Tree** | **เมื่อเข้า Rage:** ได้ **Temp HP = เลเวล Barbarian** • **เมื่อเริ่มเทิร์นระหว่าง Rage:** ให้ Temp HP กับเพื่อน 1 คนในระยะ 10 ฟุต (ทอย **d6 จำนวนเท่ากับครึ่งเลเวล Barbarian**) |
| **6** | **Branches of the Tree** | **Reaction:** เมื่อศัตรูในระยะ 30 ฟุตเริ่มเทิร์น มันทอย **STR Save** ล้มเหลว = **วาร์ปมาที่ว่างในระยะ 5 ฟุตจากคุณ** และ **Speed = 0** ในเทิร์นนั้น |
| **10** | **Battering Roots** | อาวุธ Melee ที่มี **Heavy หรือ Versatile** ได้ **Reach +10 ฟุต** และเมื่อตีโดน ใช้ Mastery **Push** หรือ **Topple** ได้ฟรี (นอกเหนือจาก Mastery ปกติ) |
| **14** | **Travel Along the Tree** | **Bonus Action ระหว่าง Rage:** วาร์ปตัวเองไปได้ **60 ฟุต** • หรือใช้ **Rage 1 ครั้ง** วาร์ปไป **150 ฟุต** พร้อมเพื่อนได้ถึง 6 คนในระยะ 10 ฟุต |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Divine Fury** | **1 ครั้ง/เทิร์น ระหว่าง Rage:** เมื่อตีโดนด้วยอาวุธ เพิ่มดาเมจ **1d6 + ครึ่งเลเวล Barbarian** เป็น **Necrotic หรือ Radiant** (เลือกตอนเลเวล 3) |
| **3** | **Warrior of the Gods** | มี **คลังเต๋าฟื้นฟู d12** เท่ากับ Prof Bonus — **Bonus Action:** ใช้เต๋ากี่ลูกก็ได้เพื่อฟื้น HP • ฟื้นคลังเมื่อ Long Rest |
| **6** | **Fanatical Focus** | **1 ครั้งต่อ Rage:** เมื่อทอย Saving Throw ล้มเหลว **ทอยใหม่ได้ +4** |
| **10** | **Zealous Presence** | **Bonus Action:** เพื่อนได้ถึง 10 คนในระยะ 60 ฟุต ได้ **Advantage ในการทอย Attack Roll และ Saving Throw** จนถึงเริ่มเทิร์นหน้าของคุณ — ใช้ได้ 1 ครั้ง/Long Rest (หรือใช้ Rage 1 ครั้งเพื่อใช้อีกรอบ) |
| **14** | **Rage Beyond Death** | **ระหว่าง Rage: HP ที่เหลือ 0 ไม่ทำให้คุณหมดสติ** — คุณยังทอย Death Save แต่**ยังสู้ต่อได้ตามปกติ** จนกว่า Rage จะจบ (ถ้าล้มเหลว 3 ครั้ง = ตายเมื่อ Rage จบ) |
