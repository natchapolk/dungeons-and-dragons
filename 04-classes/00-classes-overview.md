...
- **Lay On Hands** [แนะนำ] มี **คลัง HP = 5 คูณ เลเวล Paladin** (เลเวล 1 = 5 HP) **Bonus Action:** สัมผัสแล้วฟื้น HP ให้ใคร ๆ ก็ได้ • ใช้ 5 HP เพื่อ**แก้พิษหรือโรค** 1 อย่าง • ฟื้นเมื่อ Long Rest
