...
**เลือก A (สาย STR):** Chain Mail, Greatsword, ×2 Handaxe, Dungeoneer's Pack, **4 GP**
...
| เลเวล | Prof<br>Bonus | Features (ความสามารถ) | Second<br>Wind | Weapon<br>Mastery |
|---|---|---|---|---|
| **1** | +2 | **Fighting Style**, **Second Wind**, **Weapon Mastery** | **2** | **3** |
| **2** | +2 | **1 ครั้ง (Action Surge)** [แนะนำ], **Tactical Mind** | 2 | 3 |
| **3** | +2 | **Fighter Subclass** [แนะนำ] | 2 | 3 |
| **4** | +2 | **Ability Score Improvement (ASI)** | **3** | **4** |
| **5** | **+3** | **Extra Attack** [แนะนำ], **Tactical Shift** | 3 | 4 |
| **6** | +3 | **ASI** | 3 | 4 |
| **7** | +3 | **Subclass Feature** | 3 | 4 |
| **8** | +3 | **ASI** | 3 | 4 |
| **9** | **+4** | **1 ครั้ง (Indomitable)**, **Tactical Master** | 3 | 4 |
| **10** | +4 | **Subclass Feature** | **4** | **5** |
| **11** | +4 | **โจมตี 3 ครั้ง (Two Extra Attacks)** [แนะนำมาก] | 4 | 5 |
| **12** | +4 | **ASI** | 4 | 5 |
| **13** | **+5** | **2 ครั้ง (Indomitable)**, **Studied Attacks** | 4 | 5 |
| **14** | +5 | **ASI** | 4 | 5 |
| **15** | +5 | **Subclass Feature** | 4 | 5 |
| **16** | +5 | **ASI** | 4 | **6** |
| **17** | **+6** | **2 ครั้ง (Action Surge)**, **3 ครั้ง (Indomitable)** | 4 | 6 |
| **18** | +6 | **Subclass Feature** | 4 | 6 |
| **19** | +6 | **Epic Boon Feat** | 4 | 6 |
| **20** | +6 | **โจมตี 4 ครั้ง (Three Extra Attacks)** | 4 | 6 |
...
| เลเวล | โจมตีสูงสุดใน 1 เทิร์น (ใช้ Action Surge) |
|---|---|
| 2 | **2 ครั้ง** |
| 5 | **4 ครั้ง** |
| 11 | **6 ครั้ง** |
...
|---|---|---|
| **3** | **Improved Critical** | **Critical Hit เกิดที่ 19-20** (แทน 20 อย่างเดียว) — โอกาสคริติคอลเพิ่มเป็น 2 เท่า |
| **3** | **Remarkable Athlete** | ได้ Advantage ใน **Initiative** และ **Strength (Athletics)** Check • เมื่อทอย Advantage ในการทอย Str/Dex/Con Check สำเร็จ **เคลื่อนที่ได้ครึ่ง Speed ฟรี** |
| **7** | **Additional Fighting Style** | ได้ **Fighting Style Feat เพิ่มอีก 1 อัน** |
| **10** | **Heroic Warrior** | **ระหว่างการต่อสู้ ในตอนเริ่มเทิร์นของคุณ คุณได้ Heroic Inspiration** ถ้ายังไม่มี |
| **15** | **Superior Critical** | **Critical Hit เกิดที่ 18-20** — โอกาสคริติคอล **15%** |
| **18** | **Survivor** | ได้ **Advantage ในการทอย Death Saving Throw** • และเมื่อเริ่มเทิร์นโดย HP เหลือไม่เกินครึ่ง **ฟื้น `5 + CON modifier` HP** |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Combat Superiority** | ได้ **Superiority Dice 4 ลูก (d8)** และเรียนรู้ **Maneuver 3 ท่า** • ฟื้นเมื่อ Short/Long Rest |
| **3** | **Student of War** | ได้ Proficiency ใน **Artisan's Tools 1 ชนิด** และ **Skill 1 อย่าง** จากรายการ Fighter |
| **7** | **Know Your Enemy** | **Bonus Action:** ศึกษาศัตรูที่มองเห็นในระยะ 30 ฟุต รู้ว่ามัน**มีค่า Ability สูงกว่าหรือต่ำกว่าคุณ** และรู้ **AC, Immunity, Resistance, Vulnerability** ของมัน — ใช้ได้ Prof Bonus ครั้ง/Long Rest |
| **10** | **Improved Combat Superiority** | **Superiority Dice เป็น d10** และเรียนรู้ Maneuver เพิ่ม |
| **15** | **Relentless** | **เมื่อทอย Initiative และ Superiority Dice หมด ฟื้น 1 ลูกทันที** |
| **18** | **Ultimate Combat Superiority** | **Superiority Dice เป็น d12** |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Spellcasting** | เรียนสเปลจากรายการ **เน้น **Abjuration** และ **Evocation** (Wizard)** — ใช้ **INT** เป็นค่าร่ายเวท |
| **3** | **War Bond** | ผูกพันกับอาวุธ 2 ชิ้น **เรียกกลับมือด้วย Bonus Action** • ปลดอาวุธจากมือคุณไม่ได้ |
| **7** | **War Magic** | เมื่อใช้ **Attack action** คุณสามารถ**แทนการโจมตี 1 ครั้ง ด้วยการร่าย Cantrip** |
| **10** | **Eldritch Strike** | เมื่อตีโดนด้วยอาวุธ เป้าหมาย **เสียเปรียบใน Saving Throw ของสเปลถัดไปที่คุณร่ายใส่มัน** (จนจบเทิร์นหน้าของคุณ) |
| **15** | **Arcane Charge** | เมื่อใช้ **Action Surge** **วาร์ปได้ 30 ฟุต** |
| **18** | **Improved War Magic** | เมื่อใช้ Attack action คุณสามารถ**แทนการโจมตี 1 ครั้ง ด้วยการร่ายสเปลระดับ 1 หรือ 2** |

**ตาราง Spell Slot (Third Caster):**

| เลเวล Fighter | Cantrips | สเปลที่เตรียมได้ | Slot 1 | Slot 2 | Slot 3 | Slot 4 |
|---|---|---|---|---|---|---|
| 3 | 2 | 3 | 2 | — | — | — |
| 4 | 2 | 4 | 3 | — | — | — |
| 7 | 2 | 5 | 4 | 2 | — | — |
...
| เลเวล | Feature | ทำอะไร |
|---|---|---|
| **3** | **Psionic Power** | ได้ **จำนวน = 2× Prof Bonus (Psionic Energy Dice)** ใช้กับความสามารถ 3 อย่าง:<br>• **Protective Field** — **Reaction:** ลดดาเมจให้ตัวเองหรือเพื่อนในระยะ 30 ฟุต **1 เต๋า + INT modifier**<br>• **Psionic Strike** — 1 ครั้ง/เทิร์น เมื่อตีโดน เพิ่มดาเมจ **1 เต๋า + INT modifier** เป็น **Force**<br>• **Telekinetic Movement** — ใช้ **Bonus Action** ย้ายวัตถุหรือสิ่งมีชีวิตที่ยินยอม (ขนาด Large หรือเล็กกว่า) **ไป 30 ฟุต** |
| **7** | **Telekinetic Adept** | • **Psi-Powered Leap** — **Bonus Action:** ได้ **Fly Speed = 2× Speed** จนจบเทิร์น (ฟรี 1 ครั้ง/Long Rest หรือใช้ 1 เต๋า)<br>• **Telekinetic Thrust** — เมื่อใช้ Psionic Strike เป้าหมายทอย **STR Save** ล้มเหลว = **Prone หรือ ผลัก 10 ฟุต** |
| **10** | **Guarded Mind** | **Resistance ต่อ Psychic damage** • เมื่อเริ่มเทิร์นโดยมีสภาวะ **Charmed หรือ Frightened** ใช้ 1 เต๋าเพื่อ**ลบสภาวะนั้นทันที** |
| **15** | **Bulwark of Force** | **Bonus Action:** ให้ตัวเองและเพื่อนได้ถึง Prof Bonus คน ในระยะ 30 ฟุต ได้ **Half Cover** เป็นเวลา 1 นาที (ฟรี 1 ครั้ง/Long Rest หรือใช้ 1 เต๋า) |
| **18** | **Telekinetic Master** | ได้สเปล **`Telekinesis`** ร่ายฟรี 1 ครั้ง/Long Rest (ใช้ INT) • ระหว่างที่รักษา Concentration ใช้ **Bonus Action** โจมตีด้วยอาวุธ 1 ครั้ง |
