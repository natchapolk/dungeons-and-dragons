...
- **มีดสั้น (Dagger)** ดาเมจ 1d4 Piercing คุณสมบัติ Finesse จึงใช้ DEX ทอยได้ และขว้างได้ไกล 20 ฟุต
- **เครื่องดนตรี (Musical Instrument)** ใช้เป็น Spellcasting Focus ของ Bard ได้เลย จึงไม่ต้องซื้อ Focus แยก
- **ชุดนักแสดง (Entertainer's Pack)** มีชุดแฟนซี 2 ชุดและชุดปลอมตัว เหมาะกับการเข้าสังคมและการหลอกล่อ
- เงินติดตัว 19 GP

**เลือก B** รับเงิน 90 GP ไปซื้อของเอง

แนะนำอย่างยิ่งสำหรับมือใหม่ ให้เลือก A เพราะเครื่องดนตรีในชุดนี้ทำหน้าที่เป็น Focus ให้ด้วย
ถ้าเลือก B แล้วลืมซื้อเครื่องดนตรีหรือ **ถุงองค์ประกอบเวท (Component Pouch)** คุณจะร่ายเวทที่ต้องใช้องค์ประกอบ M ไม่ได้เลย
รายละเอียดเครื่องดนตรีทั้ง 10 ชนิดพร้อมราคา อ่านได้ที่ [ของใช้ผจญภัยและไอเทม](../01-basics/12-gear-and-items.md)
