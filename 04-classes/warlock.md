...
- **เกราะหนัง (Leather Armor)** ให้ AC 11 บวก DEX เต็มจำนวน Warlock เป็นสายเวทกลุ่มน้อยที่ใส่เกราะเบาได้
- **เคียว (Sickle)** ดาเมจ 1d4 Slashing คุณสมบัติ Light
- **มีดสั้น (Dagger)** 2 เล่ม ดาเมจ 1d4 Piercing คุณสมบัติ Finesse และขว้างได้ไกล 20 ฟุต
- **สื่อเวทอาถรรพ์ (Arcane Focus)** แบบลูกแก้ว ราคา 20 GP เป็น Spellcasting Focus ของ Warlock
- **หนังสือ (Book)** ราคา 25 GP เป็นตำราลึกลับที่บันทึกเรื่องราวของผู้อุปถัมภ์คุณ ใช้เล่นบทบาทได้ ไม่มีผลทางกฎ
- **ชุดนักปราชญ์ (Scholar's Pack)** มีหนังสือ หมึก ปากกาขนนก และตะเกียงตั้งโต๊ะ
- เงินติดตัว 15 GP

**เลือก B** รับเงิน 100 GP ไปซื้อของเอง

แนะนำสำหรับมือใหม่ ให้เลือก A เพราะลูกแก้วกับหนังสือรวมกันก็ 45 GP แล้ว
และเกราะหนังทำให้ AC สูงกว่าสายเวทคลาสอื่นตั้งแต่เลเวล 1

ข้อควรระวัง อาวุธในชุดนี้แทบไม่ได้ใช้ เพราะการโจมตีหลักของ Warlock คือ Cantrip ชื่อ **ลำแสงอาถรรพ์ (Eldritch Blast)**
ซึ่งไม่ต้องใช้อาวุธเลย ให้ถือลูกแก้วมือเดียวแล้วเหลืออีกมือไว้ทำท่า Somatic
...
- **เลเวล 3** Proficiency Bonus +2, ได้ความสามารถ Otherworldly Patron (Subclass) [แนะนำ], Invocations 3, รู้ Cantrip 2, เตรียมสเปลได้ 4, Spell Slots 2, ระดับ Slot 2
- **เลเวล 4** Proficiency Bonus +2, ได้ความสามารถ ASI, Invocations 3, รู้ Cantrip 3, เตรียมสเปลได้ 5, Spell Slots 2, ระดับ Slot 2
- **เลเวล 5** Proficiency Bonus +3, Invocations 4, รู้ Cantrip 3, เตรียมสเปลได้ 6, Spell Slots 2, ระดับ Slot 3
- **เลเวล 6** Proficiency Bonus +3, ได้ความสามารถ Subclass Feature, Invocations 4, รู้ Cantrip 3, เตรียมสเปลได้ 7, Spell Slots 2, ระดับ Slot 3
- **เลเวล 7** Proficiency Bonus +3, Invocations 5, รู้ Cantrip 3, เตรียมสเปลได้ 8, Spell Slots 2, ระดับ Slot 4
- **เลเวล 8** Proficiency Bonus +3, ได้ความสามารถ ASI, Invocations 5, รู้ Cantrip 3, เตรียมสเปลได้ 9, Spell Slots 2, ระดับ Slot 4
- **เลเวล 9** Proficiency Bonus +4, ได้ความสามารถ Contact Patron, Invocations 6, รู้ Cantrip 3, เตรียมสเปลได้ 10, Spell Slots 2, ระดับ Slot 5
- **เลเวล 10** Proficiency Bonus +4, ได้ความสามารถ Subclass Feature, Invocations 6, รู้ Cantrip 4, เตรียมสเปลได้ 10, Spell Slots 2, ระดับ Slot 5
- **เลเวล 11** Proficiency Bonus +4, ได้ความสามารถ ระดับ 6 (Mystic Arcanum) [แนะนำ], Invocations 6, รู้ Cantrip 4, เตรียมสเปลได้ 11, Spell Slots 3, ระดับ Slot 5
- **เลเวล 12** Proficiency Bonus +4, ได้ความสามารถ ASI, Invocations 7, รู้ Cantrip 4, เตรียมสเปลได้ 11, Spell Slots 3, ระดับ Slot 5
- **เลเวล 13** Proficiency Bonus +5, ได้ความสามารถ ระดับ 7 (Mystic Arcanum) [แนะนำ], Invocations 7, รู้ Cantrip 4, เตรียมสเปลได้ 12, Spell Slots 3, ระดับ Slot 5
- **เลเวล 14** Proficiency Bonus +5, ได้ความสามารถ Subclass Feature, Invocations 7, รู้ Cantrip 4, เตรียมสเปลได้ 12, Spell Slots 3, ระดับ Slot 5
- **เลเวล 15** Proficiency Bonus +5, ได้ความสามารถ ระดับ 8 (Mystic Arcanum) [แนะนำ], Invocations 8, รู้ Cantrip 4, เตรียมสเปลได้ 13, Spell Slots 3, ระดับ Slot 5
- **เลเวล 16** Proficiency Bonus +5, ได้ความสามารถ ASI, Invocations 8, รู้ Cantrip 4, เตรียมสเปลได้ 13, Spell Slots 3, ระดับ Slot 5
- **เลเวล 17** Proficiency Bonus +6, ได้ความสามารถ ระดับ 9 (Mystic Arcanum) [แนะนำ], Invocations 8, รู้ Cantrip 4, เตรียมสเปลได้ 14, Spell Slots 4, ระดับ Slot 5
- **เลเวล 18** Proficiency Bonus +6, Invocations 9, รู้ Cantrip 4, เตรียมสเปลได้ 14, Spell Slots 4, ระดับ Slot 5
- **เลเวล 19** Proficiency Bonus +6, ได้ความสามารถ Epic Boon Feat, Invocations 9, รู้ Cantrip 4, เตรียมสเปลได้ 15, Spell Slots 4, ระดับ Slot 5
- **เลเวล 20** Proficiency Bonus +6, ได้ความสามารถ Eldritch Master, Invocations 9, รู้ Cantrip 4, เตรียมสเปลได้ 15, Spell Slots 4, ระดับ Slot 5
...
ได้ Cantrip **Light** และ **Sacred Flame** ฟรี
...
Warlock ใช้ค่า CHA ในการร่ายเวท
...
รายการเวททั้งหมดของคลาสนี้ พร้อมรายละเอียดว่าร่ายด้วยอะไร ระยะเท่าไหร่ และให้ผลยังไง ย้ายไปอยู่ที่ [เวทของผู้ทำสัญญา (Warlock)](../10-spells/class-lists/warlock.md) แล้ว
