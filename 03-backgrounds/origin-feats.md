# ความสามารถพิเศษเริ่มต้น (ทั้ง 10 อย่าง) (Origin Feats)

[กลับหน้ารวม Background](00-backgrounds-overview.md) | [สารบัญ](../README.md)
...
- **Druid** Cantrip ที่ดี Guidance [แนะนำ], Produce Flame, Shillelagh [แนะนำ] (ใช้ WIS ตีด้วยไม้เท้า), Thorn Whip, Druidcraft, สเปลระดับ 1 ที่ดี Cure Wounds, Entangle, Faerie Fire, Goodberry [แนะนำ]

\* Cantrip เหล่านี้อยู่ใน PHB 2024
...
- ใช้ได้หลังทุก Short Rest = ได้หลายรอบต่อวัน
...
### Skill ที่ควรเลือก (ถ้ายังไม่มี)

- **Perception** [แนะนำมาก] ใช้บ่อยที่สุดในเกม + เพิ่ม Passive Perception
- **Stealth** [แนะนำ] ทั้งกลุ่มต้องซ่อนตัวบ่อย
- **Insight** [แนะนำ] รู้ว่า NPC โกหก
- **Athletics** Grapple, Shove, ปีน
- **Investigation** หากับดักและเบาะแส
- **Persuasion** เจรจา
...
ตารางข้างล่างมี 3 คอลัมน์ คือ คลาส, HP เลเวล 10 (CON +2) และ + Tough
...
- **10** Feat **Tavern Brawler**, ทำไม ต้องสร้างตัวละครรอบมันโดยเฉพาะ
