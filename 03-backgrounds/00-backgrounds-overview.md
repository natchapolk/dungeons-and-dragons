...
## รายการสรุปทั้ง 16 Background

- **นักบวชผู้ช่วย (Acolyte)** Ability Scores INT, WIS, CHA, Origin Feat **Magic Initiate (Cleric)**, Skills Insight, Religion, Tool Calligrapher's Supplies
- **ช่างฝีมือ (Artisan)** Ability Scores STR, DEX, INT, Origin Feat **Crafter**, Skills Investigation, Persuasion, Tool Artisan's Tools
- **นักต้มตุ๋น (Charlatan)** Ability Scores DEX, CON, CHA, Origin Feat **Skilled**, Skills Deception, Sleight of Hand, Tool Forgery Kit
- **อาชญากร (Criminal)** Ability Scores DEX, CON, INT, Origin Feat **Alert**, Skills Sleight of Hand, Stealth, Tool Thieves' Tools
- **นักแสดง (Entertainer)** Ability Scores STR, DEX, CHA, Origin Feat **Musician**, Skills Acrobatics, Performance, Tool Musical Instrument
- **ชาวนา (Farmer)** Ability Scores STR, CON, WIS, Origin Feat **Tough**, Skills Animal Handling, Nature, Tool Carpenter's Tools
- **ยาม (Guard)** Ability Scores STR, INT, WIS, Origin Feat **Alert**, Skills Athletics, Perception, Tool Gaming Set
- **มัคคุเทศก์/พรานนำทาง (Guide)** Ability Scores DEX, CON, WIS, Origin Feat **Magic Initiate (Druid)**, Skills Stealth, Survival, Tool Cartographer's Tools
- **ฤๅษี (Hermit)** Ability Scores CON, WIS, CHA, Origin Feat **Healer**, Skills Medicine, Religion, Tool Herbalism Kit
- **พ่อค้า (Merchant)** Ability Scores CON, INT, CHA, Origin Feat **Lucky**, Skills Animal Handling, Persuasion, Tool Navigator's Tools
- **ขุนนาง (Noble)** Ability Scores STR, INT, CHA, Origin Feat **Skilled**, Skills History, Persuasion, Tool Gaming Set
- **นักปราชญ์ (Sage)** Ability Scores CON, INT, WIS, Origin Feat **Magic Initiate (Wizard)**, Skills Arcana, History, Tool Calligrapher's Supplies
- **กะลาสี (Sailor)** Ability Scores STR, DEX, WIS, Origin Feat **Tavern Brawler**, Skills Acrobatics, Perception, Tool Navigator's Tools
- **อาลักษณ์ (Scribe)** Ability Scores DEX, INT, WIS, Origin Feat **Skilled**, Skills Investigation, Perception, Tool Calligrapher's Supplies
- **ทหาร (Soldier)** Ability Scores STR, DEX, CON, Origin Feat **Savage Attacker**, Skills Athletics, Intimidation, Tool Gaming Set
- **คนพเนจร (Wayfarer)** Ability Scores DEX, WIS, CHA, Origin Feat **Lucky**, Skills Insight, Stealth, Tool Thieves' Tools
...
- **Cleric** ค่าหลัก WIS, CON, Background ที่แนะนำ **Acolyte** (INT/WIS/CHA) [แนะนำ], Hermit, Sage
- **Druid** ค่าหลัก WIS, CON, Background ที่แนะนำ **Guide** (DEX/CON/WIS) [แนะนำ], Sage, Farmer
- **Fighter (STR)** ค่าหลัก STR, CON, Background ที่แนะนำ **Soldier** [แนะนำ], Guard, Farmer
- **Fighter (DEX)** ค่าหลัก DEX, CON, Background ที่แนะนำ **Soldier** [แนะนำ], Criminal, Sailor
- **Monk** ค่าหลัก DEX, WIS, Background ที่แนะนำ **Sailor** (STR/DEX/WIS) [แนะนำ], Wayfarer, Guide
- **Paladin** ค่าหลัก STR, CHA, Background ที่แนะนำ **Noble** (STR/INT/CHA) [แนะนำ], Entertainer (STR/DEX/CHA)
- **Ranger** ค่าหลัก DEX, WIS, Background ที่แนะนำ **Guide** (DEX/CON/WIS) [แนะนำ], Sailor, Wayfarer
- **Rogue** ค่าหลัก DEX, CON, Background ที่แนะนำ **Criminal** (DEX/CON/INT) [แนะนำ], Charlatan, Wayfarer
- **Sorcerer** ค่าหลัก CHA, CON, Background ที่แนะนำ **Charlatan** (DEX/CON/CHA) [แนะนำ], Merchant (CON/INT/CHA)
- **Warlock** ค่าหลัก CHA, CON, Background ที่แนะนำ **Charlatan** [แนะนำ], Merchant, Acolyte
- **Wizard** ค่าหลัก INT, CON, Background ที่แนะนำ **Sage** (CON/INT/WIS) [แนะนำ], Scribe, Merchant
...
**แนวคิดตัวละคร:** ผู้ถูกส่งออกมาปฏิบัติภารกิจของวิหาร, ผู้สูญเสียศรัทธาแล้วออกตามหาคำตอบ และ ผู้รอดชีวิตคนเดียวจากวิหารที่ถูกทำลาย
...
**แนวคิดตัวละคร:** ช่างที่ร้านถูกเผา, ผู้ตามหาวัสดุในตำนาน และ ช่างที่ประดิษฐ์ของผิดพลาดจนต้องหนี
...
**แนวคิดตัวละคร:** นักแสดงที่คณะแตกสลาย, ผู้แสวงหาเรื่องราวมาเล่า และ นักร้องที่ทำให้ขุนนางขายหน้าแล้วต้องหนี
...
**แนวคิดตัวละคร:** ยามที่ถูกไล่ออกเพราะไม่ยอมรับสินบน, ผู้เห็นความลับของเมืองแล้วต้องหนี และ ทหารยามที่ปล่อยนักโทษหลุด
...
**แนวคิดตัวละคร:** ฤๅษีที่ค้นพบความจริงบางอย่างแล้วต้องออกมาเตือนโลก, ผู้หนีจากสังคมเพราะความผิดในอดีต และ ผู้ได้รับนิมิต
...
**แนวคิดตัวละคร:** อาลักษณ์ที่คัดลอกเอกสารต้องห้าม, ผู้ค้นพบการปลอมแปลงเอกสารระดับชาติ และ นักเขียนที่อยากมีเรื่องราวของตัวเอง
...
**แนวคิดตัวละคร:** เด็กกำพร้าที่โตบนถนน, ผู้หนีจากอดีต และ คนที่เดินทางตลอดเพราะกลัวการหยุดนิ่ง
