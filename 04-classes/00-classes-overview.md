...
- **Lay On Hands** [แนะนำ] มี **คลัง HP = 5 คูณ เลเวล Paladin** (เลเวล 1 = 5 HP) **Bonus Action:** สัมผัสแล้วฟื้น HP ให้ใคร ๆ ก็ได้, ใช้ 5 HP เพื่อ**แก้พิษหรือโรค** 1 อย่าง และ ฟื้นเมื่อ Long Rest
...
- **Pact Magic** [แนะนำ] **Cantrip 2 อัน** + **เตรียมสเปลได้ 2 อัน** + **Spell Slot จำนวน 1 ช่อง** **Slot ฟื้นทุก Short Rest** [แนะนำ] และ**เป็นระดับสูงสุดที่มีเสมอ**
